...
lbp=pickle.load(open('features/Lbp_full.pkl',"rb"))
shape=pickle.load(open('features/Shape_full.pkl', "rb"))
hog=pickle.load(open('features/Hog_full.pkl', "rb"))
resnet=pickle.load(open('features/Resnet_full.pkl', "rb"))
tag=pickle.load(open('features/Tag_full.pkl', "rb"))
